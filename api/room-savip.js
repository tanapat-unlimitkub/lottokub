$(document).ready(function () {
    ...
    var _0x5d80xa = JSON.parse('[{"data":"tppp"},{"data":"bpbp"},{"data":"tpbb"},{"data":"pbbp"},{"data":"bbpb"},{"data":"bptp"},{"data":"pbpb"},{"data":"tbpb"},{"data":"pppb"},{"data":"bbtb"},{"data":"pbtp"},{"data":"bbbb"},{"data":"pptp"}]');
    var _0x5d80xb = true;
    ghtml = "";
...
function GetXmlHttpObject()
{
    ...
    function _0x5d80x1a(_0x5d80x1b) {
        $.ajax({
           ...
           console.log(_0x5d80x1c);
            if (_0x5d80x1c == "Out") {
                window.location.href = "sagame.php"
            } else {
                ...
                let _0x5d80x1e = '99999';
                $("#navCredit8").html('<img src="resource/images/new/credit.png" style="height:100%;"> &nbsp;' + _0x5d80x1e + " &nbsp;");
    ...
    function _0x5d80x22() {
        $.ajax({
            url: "database/getresult.php?id=" + _0x5d80x4,
            type: "GET",
